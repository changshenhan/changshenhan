...
| **databendlabs/databend** (9.4k★) | [#20472](https://github.com/databendlabs/databend/pull/20472) | h2 0.4.17 + quinn-proto + crossbeam-epoch + lz4_flex 0.11.6 — four RUSTSEC-2026 advisories, Cargo.lock-only *(OPEN — approved by sundy-li, CI green)* |
